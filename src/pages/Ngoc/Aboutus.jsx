            ...
            <div className="container my-5">
                <div className="row align-items-center">
                    <div className="col-md-6">
                        ...
                        <p> 
                            <strong>Snowell Electric</strong> is a trusted name in the world of home and commercial electrical appliances, dedicated to delivering innovative, energy-efficient and reliable solutions for modern living. With a passion for enhancing comfort and convenience, we provide a wide range of products—from air purifiers and fans to advanced home cleaning systems—that blend cutting-edge technology with sleek, user-friendly designs.
            ...
            <div className="container my-4">
                ...
                <p>
                    <ul>
                        ...
                        <li>Prioritize Sustainability: Reduce environmental impact through energy-efficient and eco-conscious solutions.</li>
                        <li>
            ...
            <div className="container my-5">
                ...
                <div className="row">
                    <div className="col-12 col-md-4 mb-4">
                        <div className="card text-center"  style={{ width: "250px", margin: " auto" }}>
                            <img 
                            src={process.env.PUBLIC_URL + "/img/member 1.png"} 
                            className="card-img-top" 
                            alt="Nguyen Hong Ngoc" 
                           />
                            <div className="card-body">
                                ...
                                <p className="card-text">
                                    Works on frontend development and responsive layout
                                </p>
                            </div>
                        </div>
                    </div>
                    <div className="col-12 col-md-4 mb-4">
                        <div className="card text-center"  style={{ width: "250px", margin: "0 auto" }}>
                            <img 
                            src={process.env.PUBLIC_URL + "/img/member 2.png"}  
                            className="card-img-top" 
                            alt="Nguyen Huu Tri" />
                            <div className="card-body">
